...
description: "Orchestrate multiple Agentic skills through guided workflows for SaaS MVP delivery, security audits, AI agent builds, and browser QA."
risk: none
source: self
...
```text
Use @agentic-workflows to run the "Ship a SaaS MVP" workflow for my project idea.
```

```text
Use @agentic-workflows and execute a full "Security Audit for a Web App" workflow.
```

```text
Use @agentic-workflows to guide me through "Build an AI Agent System" with checkpoints.
```

```text
Use @agentic-workflows to execute the "QA and Browser Automation" workflow and stabilize flaky tests.
```
